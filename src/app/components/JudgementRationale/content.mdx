...
<ul className={styles.toc}>
  ...
  <li>
    <a href="#/judgements/where-the-data-comes-from">Where the data comes from</a>
  </li>
</ul>
...
A druid genuinely carrying Faerie Fire duty for the fight spends real GCDs
that would otherwise go to Lifebloom upkeep; real corpus data confirmed this
measurably raises re-stack tax. When that duty is detected for the fight, the
good/fair allowance widens by {FAERIE_FIRE_DUTY_RESTACK_ALLOWANCE} casts.
