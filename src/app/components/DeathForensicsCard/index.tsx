    ...
    Promise.all([
      ...
      .then(([deathEvents, castEvents, buffEvents, combatantInfoEvents]) => {
        try {
          ...
          // actually known. Show both rows and skip the note in that case,
          // matching this project's existing precedent of leaving unknown
          // talent data unflagged rather than guessing either way.
