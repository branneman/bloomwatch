...
| ------------------ | ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `4GYHZRdtL3bvhpc8` | SSC+TK 2026-07-07              | Canonical fixture (Tiers 2/4/5). One resto druid (Dassz) among four druids; one of the other three is WCL-labeled `Druid-Restoration` despite zero healing casts that pull (playing feral) — the case that proved story 005's detection must gate on healing-cast count, not WCL's own spec label. Also validated (fight 6, Dassz's Lifebloom) that `refreshbuff` co-fires with `applybuffstack` on every stack increase, and fires solo only when refreshing at an already-maxed stack — the dedup rule story 202's refresh-cadence histogram depends on. |
