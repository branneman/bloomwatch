...
- A behavioral detector identifies "on FF duty" for a fight: the selected druid is in a Balance-leaning talent bucket (story 900/903a: `likely-dreamstate-full`, `likely-dreamstate-partial`, `mostly-balance`, or `restokin-shaped`) AND casts Faerie Fire on the boss at a sustained, roughly-40s-refresh cadence for a meaningful share of the fight — not a one-off pull-opener cast, which any archetype might do incidentally.
