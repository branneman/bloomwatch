...
- `docs/roadmap.md` and CLAUDE.md's principle 1 are updated to describe the widened scope (TBC content generally — Anniversary _and_ the 2021-2022 TBC Classic launch — still excluding every other expansion/realm type) once this ships.
